...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 82.5s with 110s block interval) */
static const int64_t BLOCK_DOWNLOAD_TIMEOUT_BASE = 750000;
