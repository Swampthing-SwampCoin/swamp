...
These denominations are 0.01 SWAMP, 0.1 SWAMP, 1 SWAMP and 10 SWAMP -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Swamp Core is shutting down...") + "<br /><br />" +
