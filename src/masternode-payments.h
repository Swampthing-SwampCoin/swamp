...
bool IsBlockPayeeValid(const CTransaction& txNew, int nBlockHeight, CAmount blockReward, bool fRequireMasternodePayment = false);
...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, bool fRequireMasternodePayment = false);
...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, int nBlockHeight, bool fRequireMasternodePayment = false);
